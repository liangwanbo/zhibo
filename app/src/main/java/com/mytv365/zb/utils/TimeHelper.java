...
public class TimeHelper {
	...
	public static String friendly_time() {
		...
		String time = null;
		if (nowtime <= 6) {
			time = "凌晨" + dateFormater3.get().format(new Date());
		} else if (nowtime <= 11) {
			time = "上午" + dateFormater3.get().format(new Date());
		} else if (nowtime <= 13) {
			time = "中午" + dateFormater3.get().format(new Date());
		} else if (nowtime <= 17) {
			time = "下午" + dateFormater3.get().format(new Date());
		} else {
			time = "晚上" + dateFormater3.get().format(new Date());
		}
	 ...
	 */
	public static String toDateYYYYMMDD6(String dateString) {
		String result = TimeHelper.formatToString(dateString, "yyyy-MM-dd");
		return result;
	}
	 ...
	 * @return
	 */
	public static boolean isEarly(String dateStr) {
		// if(dateStr==null||"".equals(dateStr)){
		// return true;
		// }
		boolean isEarly = false;
		Date date = toDate5(dateStr);
