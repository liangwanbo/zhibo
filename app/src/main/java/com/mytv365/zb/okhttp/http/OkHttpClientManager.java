package com.mytv365.zb.okhttp.http;
...
import com.mytv365.zb.okhttp.callback.OkHttpCallBack;
import com.mytv365.zb.okhttp.cookie.PersistentCookieStore;
import com.mytv365.zb.okhttp.util.ImageUtils;
import com.mytv365.zb.utils.HttpsUtils;
...
public class OkHttpClientManager {
    ...
    private OkHttpClientManager() {
        ...
        ClearableCookieJar cookieJar1 = new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(GlobalApplication.gainContext()));
        mOkHttpClient = new OkHttpClient.Builder()
                ...
                .cookieJar(new CookieJar() {
                    private final PersistentCookieStore cookieStore = new PersistentCookieStore(GlobalApplication.gainContext());
                    @Override
...
//                                view.setImageBitmap(BitmapUtils.toRoundBitmap(bm));
    ...
    public static void postAsyn(String url, StringCallback callback, File file, String fileKey, String s) throws IOException {
