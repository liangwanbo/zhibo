 ...
 * 自定义ListView
 * @author ZhangGuoHao
 * @date 2016年4月11日 上午11:33:26
 */
public class ListViewScoll extends ListView implements OnScrollListener {
    ...
    public ListViewScoll(Context context, AttributeSet attrs,
                                 int defStyle) {
    ...
    public ListViewScoll(Context context) {
        super(context);
        init(context);
    }
