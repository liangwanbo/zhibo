...
import com.fhrj.library.base.impl.BaseService;
...
/***
 * * 网络状态监听Service<br>
 * 使用说明： 1、添加权限 <uses-permission
 * android:name="android.permission.ACCESS_NETWORK_STATE" /> 2、注册Service
 * <service android:enabled="true" android:name="NetworkStateService的实现类" />
 * 3、在合适的地方启动Service
 * ，可以在Application启动的时候启动，startService(Intent(mContext,NetworkStateService
 * .class));
 * 
 * @author zhangguohao
 *
